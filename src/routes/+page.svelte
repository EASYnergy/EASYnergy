<script lang="ts">
    ...
    function handleLogin() {
      // Check if both the email and password inputs are filled
      if (email.trim() !== '' && password.trim() !== '') {
        // Navigate to the Eventmain component
        goto('/Eventmain');
      } else {
        // Optionally, show an error if inputs are not filled
